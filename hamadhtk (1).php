...
$token = "8252765251:AAEkp5AZ7_4QChprvcMy3qTtZ8N9PxwsWLk";//توكنك هنا
$tokens = "8252765251:AAEkp5AZ7_4QChprvcMy3qTtZ8N9PxwsWLk"; //توكنك مرة اخرئ
#تعديل وتطوير حمادة 
define('API_KEY',$token);
function bot($method,$datas=[]){
$url = "https://telegram-bat-v-8-php.onrender.com".API_KEY."/".$method;
$ch = curl_init();
...
### ###حماده### حماده ###
$sudo = array("$حمادهv","5802603356");#ايدي ادمن اخر
$idbot = "8252765251"; #ايدي البوت
$userbot = "A_S_P_Year_bot"; #يوزر البوت
$userbots = "@$userbot";//لاتغير شي هون
$buy = "A_S_P_Y"; #معرف المطور
$chi = "hatwgj"; #معرف قناتك
mkdir("sudo");
mkdir("data");
